!(function () {
    ...
    "undefined" != typeof window && (d = i = window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder || window.BlobBuilder),
        ...
        (h.prototype.unpack_string = function (e) {
            for (var t, r, n = this.read(e), i = 0, o = ""; i < e; )
                (t = n[i]) < 128
                    ...
                    : ((r = ((15 & t) << 12) | ((63 & n[i + 1]) << 6) | (63 & n[i + 2])), (o += String.fromCharCode(r)), (i += 3));
    ...
    function w(e) {
        ...
        var r = e.navigator;
        if (r.mozGetUserMedia) (t.browser = "firefox"), (t.version = b(r.userAgent, /Firefox\/(\d+)\./, 1));
        else if (r.webkitGetUserMedia || (!1 === e.isSecureContext && e.webkitRTCPeerConnection && !e.RTCIceGatherer)) (t.browser = "chrome"), (t.version = b(r.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
        else if (r.mediaDevices && r.userAgent.match(/Edge\/(\d+).(\d+)$/)) (t.browser = "edge"), (t.version = b(r.userAgent, /Edge\/(\d+).(\d+)$/, 2));
        else {
            if (!e.RTCPeerConnection || !r.userAgent.match(/AppleWebKit\/(\d+)\./)) return (t.browser = "Not a supported browser."), t;
            (t.browser = "safari"), (t.version = b(r.userAgent, /AppleWebKit\/(\d+)\./, 1)), (t.supportsUnifiedPlan = e.RTCRtpTransceiver && "currentDirection" in e.RTCRtpTransceiver.prototype);
        }
        return t;
    }
    function P(e) {
                ...
                i = function (e, i) {
                    ...
                    if (e && "object" == typeof e.video) {
                        ...
                        if (a && ("user" === a.exact || "environment" === a.exact || "user" === a.ideal || "environment" === a.ideal) && (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || c))
                            if ((delete e.video.facingMode, "environment" === a.exact || "environment" === a.ideal ? (s = ["back", "rear"]) : ("user" !== a.exact && "user" !== a.ideal) || (s = ["front"]), s))
                                return r.mediaDevices.enumerateDevices().then(function (t) {
                                    ...
                                    return (
                                        !r && t.length && s.includes("back") && (r = t[t.length - 1]),
                                        r && (e.video.deviceId = a.exact ? { exact: r.deviceId } : { ideal: r.deviceId }),
                                        (e.video = n(e.video)),
                ...
                ("function" == typeof t
                    ? (e.navigator.mediaDevices.getDisplayMedia = function (r) {
                          return t(r).then(function (t) {
                              ...
                              return (
                                  (r.video = { mandatory: { chromeMediaSource: "desktop", chromeMediaSourceId: t, maxFrameRate: o || 3 } }),
    ...
    function K(e, t, r, n, i) {
        ...
        if (
            ...
            (o += W.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : i || "active")),
            (o += "a=mid:" + e.mid + "\r\n"),
            ...
            (o += "a=" + s),
                ...
                e.sendEncodingParameters[0].rtx && ((o += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + s), (o += "a=ssrc-group:FID " + e.sendEncodingParameters[0].ssrc + " " + e.sendEncodingParameters[0].rtx.ssrc + "\r\n"));
        }
        return (
            (o += "a=ssrc:" + e.sendEncodingParameters[0].ssrc + " cname:" + W.localCName + "\r\n"),
    ...
    (H.generateIdentifier = function () {
        ...
        (H.getDtlsParameters = function (e, t) {
            return { role: "auto", fingerprints: H.matchPrefix(e + t, "a=fingerprint:").map(H.parseFingerprint) };
        }),
        ...
        (H.parseCryptoKeyParams = function (e) {
            ...
            return { keyMethod: "inline", keySalt: t[0], lifeTime: t[1], mkiValue: t[2] ? t[2].split(":")[0] : void 0, mkiLength: t[2] ? t[2].split(":")[1] : void 0 };
        }),
        ...
        (H.parseRtpParameters = function (e) {
            for (var t = { codecs: [], headerExtensions: [], fecMechanisms: [], rtcp: [] }, r = H.splitLines(e)[0].split(" "), n = 3; n < r.length; n++) {
                var i = r[n],
        ...
        (H.parseRtpEncodingParameters = function (e) {
            ...
            c.length > 0 && c[0].length > 1 && c[0][0] === s && (t = c[0][1]),
                n.codecs.forEach(function (e) {
                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        s && t && (n.rtx = { ssrc: t }), r.push(n), i && (((n = JSON.parse(JSON.stringify(n))).fec = { ssrc: s, mechanism: o ? "red+ulpfec" : "red" }), r.push(n));
                    }
                }),
            ...
            return (
                p.length &&
                    ((p = 0 === p[0].indexOf("b=TIAS:") ? parseInt(p[0].substr(7), 10) : 0 === p[0].indexOf("b=AS:") ? 950 * parseInt(p[0].substr(5), 10) - 16e3 : void 0),
        ...
        (H.parseSctpDescription = function (e) {
            ...
            if (i.length > 0) return { port: parseInt(i[0].substr(12), 10), protocol: r.fmt, maxMessageSize: t };
        ...
        (H.writeMediaSection = function (e, t, r, n) {
            ...
            if (
                ...
                (i += H.writeDtlsParameters(e.dtlsTransport.getLocalParameters(), "offer" === r ? "actpass" : "active")),
                (i += "a=mid:" + e.mid + "\r\n"),
                ...
                (i += "a=" + o),
                    ...
                    e.sendEncodingParameters[0].rtx && ((i += "a=ssrc:" + e.sendEncodingParameters[0].rtx.ssrc + " " + o), (i += "a=ssrc-group:FID " + e.sendEncodingParameters[0].ssrc + " " + e.sendEncodingParameters[0].rtx.ssrc + "\r\n"));
            }
            return (
                (i += "a=ssrc:" + e.sendEncodingParameters[0].ssrc + " cname:" + H.localCName + "\r\n"),
        ...
        (H.isValidSDP = function (e) {
            ...
            for (var t = H.splitLines(e), r = 0; r < t.length; r++) if (t[r].length < 2 || "=" !== t[r].charAt(1)) return !1;
            return !0;
        }),
        (W = H),
        (J = function (e, t) {
            var r = function (t, r) {
                ...
                i = function (r) {
                    ...
                    if (
                        ...
                        throw X("NotSupportedError", "rtcpMuxPolicy 'negotiate' is not supported");
                    ...
                    if (
                                ...
                                if (e && (e.urls || e.url)) {
                                    ...
                                    return (
                                        ...
                                        (n = n.filter(function (e) {
                                            return 0 !== e.indexOf("turn:") || -1 === e.indexOf("transport=udp") || -1 !== e.indexOf("turn:[") || r
                        ...
                        for (var o = r.iceCandidatePoolSize; o > 0; o--) this._iceGatherers.push(new e.RTCIceGatherer({ iceServers: r.iceServers, gatherPolicy: r.iceTransportPolicy }));
            ...
            Object.defineProperty(i.prototype, "localDescription", {
                            ...
                            (i.onlocalcandidate = function (e) {
                                if (!(n.usingBundle && r > 0)) {
                                    ...
                                    if (s) ("new" !== i.state && "gathering" !== i.state) || (i.state = "completed");
                                        ...
                                        (o.candidate = Object.assign(o.candidate, W.parseCandidate(c))),
                                    ...
                                    "gathering" !== n.iceGatheringState && ((n.iceGatheringState = "gathering"), n._emitGatheringStateChange()),
                                        ...
                                        d && (n._dispatchEvent("icecandidate", new Event("icecandidate")), (n.iceGatheringState = "complete"), n._emitGatheringStateChange());
                                }
                            }),
                            e.setTimeout(function () {
                ...
                (i.prototype._transceive = function (e, r, n) {
                    ...
                    r &&
                        ...
                        (i.rtcp = { cname: W.localCName, compound: e.rtcpParameters.compound }),
                ...
                (i.prototype.setLocalDescription = function (e) {
                    ...
                    return (n._localDescription = { type: e.type, sdp: e.sdp }), "offer" === e.type ? n._updateSignalingState("have-local-offer") : n._updateSignalingState("stable"), Promise.resolve();
                }),
                (i.prototype.setRemoteDescription = function (i) {
                    ...
                    return (
                        (o.canTrickleIceCandidates = !!l && l.substr(14).split(" ").indexOf("trickle") >= 0),
                        c.forEach(function (n, c) {
                            ...
                            if (h || ("application" === f && ("DTLS/SCTP" === m || "UDP/DTLS/SCTP" === m))) o.transceivers[c] = { mid: g, kind: f, protocol: m, rejected: !0 };
                            else {
                                ...
                                if (
                                    ...
                                    if ("answer" === i.type && !h) {
                                        (C = (b = o.transceivers[c]).iceGatherer),
                                            ...
                                            (u && 0 !== c) || ("new" === _.state && _.start(C, E, "controlling"), "new" === S.state && S.start(x)),
                                            !Y(b.localCapabilities, b.remoteCapabilities).codecs.filter(function (e) {
                                                return "rtx" === e.name.toLowerCase();
                                            }).length &&
                                                b.sendEncodingParameters[0].rtx &&
                                                delete b.sendEncodingParameters[0].rtx,
                                            o._transceive(b, "sendrecv" === v || "recvonly" === v, "sendrecv" === v || "sendonly" === v),
                                            !T || ("sendrecv" !== v && "sendonly" !== v)
                                                ? delete b.rtpReceiver
                                                : ((R = T.track),
                                                  y
                                                      ? (a[y.stream] || (a[y.stream] = new e.MediaStream()), r(R, a[y.stream]), s.push([R, T, a[y.stream]]))
                                                      : (a.default || (a.default = new e.MediaStream()), r(R, a.default), s.push([R, T, a.default])));
                                    }
                                } else {
                                    ((b = o.transceivers[c] || o._createTransceiver(f)).mid = g),
                                        b.iceGatherer || (b.iceGatherer = o._createIceGatherer(c, u)),
                                        M.length &&
                                        ...
                                        (k = b.sendEncodingParameters || [{ ssrc: 1001 * (2 * c + 2) }]);
                                    var j,
                                        A = !1;
                                    if ("sendrecv" === v || "sendonly" === v) {
                                        if (((A = !b.rtpReceiver), (T = b.rtpReceiver || new e.RTCRtpReceiver(b.dtlsTransport, f)), A))
                                            (R = T.track),
                                                (y && "-" === y.stream) ||
                                                    (y
                                                        ? (a[y.stream] ||
                                                          ...
                                                          (j = a[y.stream]))
                                                        : (a.default || (a.default = new e.MediaStream()), (j = a.default))),
                                    ...
                                    (b.localCapabilities = P), (b.remoteCapabilities = D), (b.rtpReceiver = T), (b.rtcpParameters = O), (b.sendEncodingParameters = k), (b.recvEncodingParameters = w), o._transceive(o.transceivers[c], !1, A);
                                }
                            }
                        }),
                ...
                (i.prototype.createOffer = function () {
                    ...
                    if (o) {
                        ...
                        void 0 !== o.offerToReceiveAudio && (n = !0 === o.offerToReceiveAudio ? 1 : !1 === o.offerToReceiveAudio ? 0 : o.offerToReceiveAudio),
                            void 0 !== o.offerToReceiveVideo && (i = !0 === o.offerToReceiveVideo ? 1 : !1 === o.offerToReceiveVideo ? 0 : o.offerToReceiveVideo);
                    }
                    for (
                        ...
                        n > 0 && (r._createTransceiver("audio"), n--), i > 0 && (r._createTransceiver("video"), i--);
                    ...
                    r.transceivers.forEach(function (n, i) {
                        ...
                        o && t >= 15019 && "video" === a && !p[0].rtx && (p[0].rtx = { ssrc: p[0].ssrc + 1 }),
                        ...
                        if (!(o + 1 > i)) {
                            ...
                            if (e.stream)
                                "audio" === e.kind ? (a = e.stream.getAudioTracks()[0]) : "video" === e.kind && (a = e.stream.getVideoTracks()[0]),
                                    a && t >= 15019 && "video" === e.kind && !e.sendEncodingParameters[0].rtx && (e.sendEncodingParameters[0].rtx = { ssrc: e.sendEncodingParameters[0].ssrc + 1 });
                        ...
                        : new Promise(function (n, i) {
                              ...
                              if (e && "" !== e.candidate) {
                                  ...
                                  0 === p.indexOf("a=") && (p = p.substr(2)),
                                      ((t = W.getMediaSections(r._remoteDescription.sdp))[o] += "a=" + (c.type ? p : "end-of-candidates") + "\r\n"),
                                      (r._remoteDescription.sdp = W.getDescription(r._remoteDescription.sdp) + t.join(""));
                              } else for (var d = 0; d < r.transceivers.length && (r.transceivers[d].rejected || (r.transceivers[d].iceTransport.addRemoteCandidate({}), ((t = W.getMediaSections(r._remoteDescription.sdp))[d] += "a=end-of-candidates\r\n"), (r._remoteDescription.sdp = W.getDescription(r._remoteDescription.sdp) + t.join("")), !r.usingBundle)); d++);
                              n();
                          });
                }),
                        ...
                        return n.apply(this).then(function (e) {
                            ...
                            return (
                                Object.keys(e).forEach(function (r) {
                                    var n;
                                    (e[r].type =
                                        { inboundrtp: "inbound-rtp", outboundrtp: "outbound-rtp", candidatepair: "candidate-pair", localcandidate: "local-candidate", remotecandidate: "remote-candidate" }[(n = e[r]).type] || n.type),
                                        t.set(r, e[r]);
                                }),
                                t
                            );
    ...
    function Ce(e) {
        return e && void 0 !== e.video ? Object.assign({}, e, { video: R(e.video) }) : e;
    }
    function _e(e) {
        if (e.RTCPeerConnection) {
            ...
            if (e) {
                ...
                !1 === e.offerToReceiveVideo && n
                    ? "sendrecv" === n.direction
                        ...
                        : "recvonly" === n.direction && (n.setDirection ? n.setDirection("inactive") : (n.direction = "inactive"))
        ...
        if (!(!t.RTCIceCandidate || (t.RTCIceCandidate && "foundation" in t.RTCIceCandidate.prototype))) {
            ...
            (t.RTCIceCandidate = function (t) {
                ...
                C(t, "icecandidate", function (e) {
                    return e.candidate && Object.defineProperty(e, "candidate", { value: new t.RTCIceCandidate(e.candidate), writable: "false" }), e;
                });
        }
    }
    function Re(t, r) {
        ...
        if (e.RTCPeerConnection && e.RTCPeerConnection.prototype) {
            ...
            r &&
                ...
                (e.RTCPeerConnection.prototype.addIceCandidate = function () {
                    return arguments[0]
                        ? (("chrome" === t.browser && t.version < 78) || ("firefox" === t.browser && t.version < 68) || "safari" === t.browser) && arguments[0] && "" === arguments[0].candidate
                            ? Promise.resolve()
                            : r.apply(this, arguments)
    ...
    var Ie,
        ...
        je = (function () {
            var e = (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}).window,
                t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { shimChrome: !0, shimFirefox: !0, shimEdge: !0, shimSafari: !0 },
                r = T,
                n = w(e),
                i = { browserDetails: n, commonShim: we, extractVersion: b, disableLog: _, disableWarnings: S };
            switch (n.browser) {
                case "chrome":
        ...
        Ie)(),
        Ne = { iceServers: [{ urls: "stun:stun.l.google.com:19302" }, { urls: ["turn:eu-0.turn.peerjs.com:3478", "turn:us-0.turn.peerjs.com:3478"], username: "peerjs", credential: "peerjsp" }], sdpSemantics: "unified-plan" },
        Fe = new (((Me = function () {
            (this.CLOUD_HOST = "0.peerjs.com"),
                ...
                (this.supports = (function () {
                    var e,
                        t = { browser: Be.isBrowserSupported(), webRTC: Be.isWebRTCSupported(), audioVideo: !1, data: !1, binaryBlob: !1, reliable: !1 };
                    if (!t.webRTC) return t;
                    try {
                        (e = new RTCPeerConnection(Ne)), (t.audioVideo = !0);
                        var r = void 0;
                        try {
                            (r = e.createDataChannel("_PEERJSTEST", { ordered: !0 })), (t.data = !0), (t.reliable = !!r.ordered);
                            try {
    ...
    Object.create && ((Je.prototype = Object.create(null)), new Je().__proto__ || (Ve = !1)),
        (Ye.prototype.eventNames = function () {
            var e,
                t,
                r = [];
            if (0 === this._eventsCount) return r;
            for (t in (e = this._events)) Ge.call(e, t) && r.push(Ve ? t.slice(1) : t);
        ...
        (Ye.prototype.emit = function (e, t, r, n, i, o) {
            ...
            if (p.fn) {
                ...
                var u,
                    l = p.length;
                for (c = 0; c < l; c++)
                    switch ((p[c].once && this.removeListener(e, p[c].fn, void 0, !0), d)) {
                        case 1:
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            if (!s) for (u = 1, s = new Array(d - 1); u < d; u++) s[u - 1] = arguments[u];
        ...
        (Ye.prototype.removeListener = function (e, t, r, n) {
            ...
            if (o.fn) o.fn !== t || (n && !o.once) || (r && o.context !== r) || Ke(this, i);
            else {
        ...
        (Ye.prototype.removeAllListeners = function (e) {
            var t;
            return e ? ((t = Ve ? Ve + e : e), this._events[t] && Ke(this, t)) : ((this._events = new Je()), (this._eventsCount = 0)), this;
        }),
    ...
    var et,
        ...
        at =
            ...
            (et.prototype.log = function () {
                ...
                this._logLevel >= Qe.All && this._print.apply(this, Ze([Qe.All], Xe(e), !1));
            }),
            (et.prototype.warn = function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                this._logLevel >= Qe.Warnings && this._print.apply(this, Ze([Qe.Warnings], Xe(e), !1));
            }),
            (et.prototype.error = function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                this._logLevel >= Qe.Errors && this._print.apply(this, Ze([Qe.Errors], Xe(e), !1));
            }),
            ...
            (et.prototype._print = function (e) {
                ...
                e >= Qe.All ? console.log.apply(console, Ze([], Xe(n), !1)) : e >= Qe.Warnings ? console.warn.apply(console, Ze(["WARNING"], Xe(n), !1)) : e >= Qe.Errors && console.error.apply(console, Ze(["ERROR"], Xe(n), !1));
            }),
            et),
        st = new at(),
        ct = {};
                ...
                (t.prototype.start = function (e, t) {
                    ...
                    !this._socket &&
                        ...
                        (this._socket.onmessage = function (e) {
                            var t;
                            try {
                                (t = JSON.parse(e.data)), qe.default.log("Server message received:", t);
                            } catch (t) {
                        ...
                        (this._socket.onclose = function (e) {
                            r._disconnected || (qe.default.log("Socket closed.", e), r._cleanup(), (r._disconnected = !0), r.emit(it.Disconnected));
                        }),
                        (this._socket.onopen = function () {
                            r._disconnected || (r._sendQueuedMessages(), qe.default.log("Socket open"), r._scheduleHeartbeat());
                        }));
                }),
        ...
        _t = (function () {
            ...
            return (
                (e.prototype.startConnection = function (e) {
                    ...
                    if (((this.connection.peerConnection = t), this.connection.type === tt.Media && e._stream && this._addTracksToConnection(e._stream, t), e.originator)) {
                ...
                (e.prototype._setupListeners = function (e) {
                    ...
                    qe.default.log("Listening for ICE candidates."),
                        (e.onicecandidate = function (e) {
                            e.candidate &&
                                e.candidate.candidate &&
                                (qe.default.log("Received ICE candidates for ".concat(r, ":"), e.candidate), o.socket.send({ type: ot.Candidate, payload: { candidate: e.candidate, type: i, connectionId: n }, dst: r }));
                        }),
                        (e.oniceconnectionstatechange = function () {
                            switch (e.iceConnectionState) {
                                case "failed":
                                    qe.default.log("iceConnectionState is failed, closing connections to " + r), t.connection.emit("error", new Error("Negotiation of connection to " + r + " failed.")), t.connection.close();
                                    break;
                                case "closed":
                                    qe.default.log("iceConnectionState is closed, closing connections to " + r), t.connection.emit("error", new Error("Connection to " + r + " closed.")), t.connection.close();
                                    break;
                                case "disconnected":
                                    qe.default.log("iceConnectionState changed to disconnected on the connection with " + r);
                                    break;
                                case "completed":
                ...
                (e.prototype.cleanup = function () {
                    qe.default.log("Cleaning up PeerConnection to " + this.connection.peer);
                            ...
                            switch (s.label) {
                                ...
                                case 2:
                                    (r = s.sent()),
                                        ...
                                        this.connection.options.sdpTransform && "function" == typeof this.connection.options.sdpTransform && (r.sdp = this.connection.options.sdpTransform(r.sdp) || r.sdp),
                                        (s.label = 3);
                                case 3:
                                ...
                                case 4:
                                    return (
                                        s.sent(),
                                        qe.default.log("Set localDescription:", r, "for:".concat(this.connection.peer)),
                                        (n = { sdp: r, type: this.connection.type, connectionId: this.connection.connectionId, metadata: this.connection.metadata, browser: Fe.browser }),
                                        this.connection.type === tt.Data && ((i = this.connection), (n = gt(gt({}, n), { label: i.label, reliable: i.reliable, serialization: i.serialization }))),
                                        t.socket.send({ type: ot.Offer, payload: n, dst: this.connection.peer }),
                                        [3, 6]
                                    );
                                case 5:
                                    return (
                                        "OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer" != (o = s.sent()) && (t.emitError(rt.WebRTC, o), qe.default.log("Failed to setLocalDescription, ", o)), [3, 6]
                                    );
                                case 6:
                                    return [3, 8];
                                case 7:
                                    return (a = s.sent()), t.emitError(rt.WebRTC, a), qe.default.log("Failed to createOffer, ", a), [3, 8];
                                case 8:
                                    return [2];
                            }
                        });
                            ...
                            switch (o.label) {
                                ...
                                case 4:
                                    return (
                                        o.sent(),
                                        qe.default.log("Set localDescription:", r, "for:".concat(this.connection.peer)),
                                        t.socket.send({ type: ot.Answer, payload: { sdp: r, type: this.connection.type, connectionId: this.connection.connectionId, browser: Fe.browser }, dst: this.connection.peer }),
                                        [3, 6]
                                    );
                                case 5:
                                    return (n = o.sent()), t.emitError(rt.WebRTC, n), qe.default.log("Failed to setLocalDescription, ", n), [3, 6];
                                case 6:
                                    return [3, 8];
                                case 7:
                                    return (i = o.sent()), t.emitError(rt.WebRTC, i), qe.default.log("Failed to create answer, ", i), [3, 8];
                                case 8:
                                    return [2];
                            }
                        });
                ...
                (e.prototype.handleSDP = function (e, t) {
                    return bt(this, void 0, Promise, function () {
                        ...
                        return Ct(this, function (a) {
                            switch (a.label) {
                                case 0:
                                    (t = new RTCSessionDescription(t)), (r = this.connection.peerConnection), (n = this.connection.provider), qe.default.log("Setting remote description", t), (i = this), (a.label = 1);
                                case 1:
                                    return a.trys.push([1, 5, , 6]), [4, r.setRemoteDescription(t)];
                                case 2:
                                    return a.sent(), qe.default.log("Set remoteDescription:".concat(e, " for:").concat(this.connection.peer)), "OFFER" !== e ? [3, 4] : [4, i._makeAnswer()];
                                case 3:
                                    a.sent(), (a.label = 4);
                                case 4:
                                    return [3, 6];
                                case 5:
                                    return (o = a.sent()), n.emitError(rt.WebRTC, o), qe.default.log("Failed to setRemoteDescription, ", o), [3, 6];
                                case 6:
                                    return [2];
                            }
                        });
                ...
                (e.prototype.handleCandidate = function (e) {
                    return bt(this, void 0, Promise, function () {
                        ...
                        return Ct(this, function (s) {
                            switch (s.label) {
                                case 0:
                                    qe.default.log("handleCandidate:", e), (t = e.candidate), (r = e.sdpMLineIndex), (n = e.sdpMid), (i = this.connection.peerConnection), (o = this.connection.provider), (s.label = 1);
                                case 1:
                                    return s.trys.push([1, 3, , 4]), [4, i.addIceCandidate(new RTCIceCandidate({ sdpMid: n, sdpMLineIndex: r, candidate: t }))];
                                case 2:
                                    return s.sent(), qe.default.log("Added ICE candidate for:".concat(this.connection.peer)), [3, 4];
                                case 3:
                                    return (a = s.sent()), o.emitError(rt.WebRTC, a), qe.default.log("Failed to handleCandidate, ", a), [3, 4];
                                case 4:
                                    return [2];
                            }
                        });
                ...
                (e.prototype._addTracksToConnection = function (e, t) {
                    if ((qe.default.log("add tracks from stream ".concat(e.id, " to peer connection")), !t.addTrack)) return qe.default.error("Your browser does't support RTCPeerConnection#addTrack. Ignored.");
                    e.getTracks().forEach(function (r) {
                        t.addTrack(r, e);
                    });
                }),
                (e.prototype._addStreamToMediaConnection = function (e, t) {
                    qe.default.log("add stream ".concat(e.id, " to media connection ").concat(t.connectionId)), t.addStream(e);
                }),
                e
            );
        })(),
        ...
        Et = (function (e) {
            function t(r, n, i) {
                ...
                return (
                    ...
                    (o.connectionId = o.options.connectionId || t.ID_PREFIX + Fe.randomToken()),
            ...
            return (
                ...
                (t.prototype.addStream = function (t) {
                    qe.default.log("Receiving stream", t), (this._remoteStream = t), e.prototype.emit.call(this, "stream", t);
                }),
                (t.prototype.handleMessage = function (e) {
                    ...
                    switch (e.type) {
                        ...
                        case ot.Candidate:
                            ...
                            break;
                        default:
                            qe.default.warn("Unrecognized message type:".concat(t, " from peer:").concat(this.peer));
                    }
                }),
                (t.prototype.answer = function (e, t) {
                    var r, n;
                    if ((void 0 === t && (t = {}), this._localStream)) qe.default.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
                    else {
                        (this._localStream = e), t && t.sdpTransform && (this.options.sdpTransform = t.sdpTransform), this._negotiator.startConnection(Pt(Pt({}, this.options._payload), { _stream: e }));
                ...
                (t.prototype.close = function () {
                    this._negotiator && (this._negotiator.cleanup(), (this._negotiator = null)),
                        ...
                        this.open && ((this._open = !1), e.prototype.emit.call(this, "close"));
                }),
                (t.ID_PREFIX = "mc_"),
                t
            );
            ...
            var t = function () {
                ...
                return (
                    ...
                    (t.fileReader.onerror = function (e) {
                        qe.default.error("EncodingQueue error:", e), (t._processing = !1), t.destroy(), t.emit("error", e);
                    }),
                    t
                );
            };
        ...
        At = (function (e) {
            function t(r, n, i) {
                ...
                return (
                    ...
                    o._encodingQueue.on("error", function () {
                        qe.default.error("DC#".concat(o.connectionId, ": Error occured in encoding from blob to arraybuffer, close DC")), o.close();
                    }),
                    (o._negotiator = new yt.Negotiator(o)),
            ...
            return (
                ...
                (t.prototype._configureDataChannel = function () {
                    var e = this;
                    (Fe.supports.binaryBlob && !Fe.supports.reliable) || (this.dataChannel.binaryType = "arraybuffer"),
                        (this.dataChannel.onopen = function () {
                            qe.default.log("DC#".concat(e.connectionId, " dc connection success")), (e._open = !0), e.emit("open");
                        }),
                        (this.dataChannel.onmessage = function (t) {
                            qe.default.log("DC#".concat(e.connectionId, " dc onmessage:"), t.data), e._handleDataMessage(t);
                        }),
                        (this.dataChannel.onclose = function () {
                            qe.default.log("DC#".concat(e.connectionId, " dc closed for:"), e.peer), e.close();
                        });
                }),
                (t.prototype._handleDataMessage = function (t) {
                    var r = this,
                        ...
                        i = n.constructor,
                        o = n;
                    if (this.serialization === nt.Binary || this.serialization === nt.BinaryUTF8) {
                        if (i === Blob)
                    ...
                    o.__peerData ? this._handleChunk(o) : e.prototype.emit.call(this, "data", o);
                }),
                ...
                (t.prototype.close = function () {
                    (this._buffer = []),
                        ...
                        this._negotiator && (this._negotiator.cleanup(), (this._negotiator = null)),
                        this.provider && (this.provider._removeConnection(this), (this.provider = null)),
                        this.dataChannel && ((this.dataChannel.onopen = null), (this.dataChannel.onmessage = null), (this.dataChannel.onclose = null), (this._dc = null)),
                        this._encodingQueue && (this._encodingQueue.destroy(), this._encodingQueue.removeAllListeners(), (this._encodingQueue = null)),
                        this.open && ((this._open = !1), e.prototype.emit.call(this, "close"));
                }),
                (t.prototype.send = function (t, r) {
                    if (this.open)
                        if (this.serialization === nt.JSON) this._bufferedSend(this.stringify(t));
                        else if (this.serialization === nt.Binary || this.serialization === nt.BinaryUTF8) {
                            var n = Fe.pack(t);
                            if (!r && n.size > Fe.chunkedMTU) return void this._sendChunks(n);
                            Fe.supports.binaryBlob ? this._bufferedSend(n) : this._encodingQueue.enque(n);
                        } else this._bufferedSend(t);
                    else e.prototype.emit.call(this, "error", new Error("Connection is not open. You should listen for the `open` event before sending messages."));
                }),
                ...
                (t.prototype._trySend = function (e) {
                    ...
                    try {
                        ...
                        return qe.default.error("DC#:".concat(this.connectionId, " Error when sending:"), e), (this._buffering = !0), this.close(), !1;
                    }
                    return !0;
                }),
                ...
                (t.prototype._sendChunks = function (e) {
                    var t,
                        r,
                        n = Fe.chunk(e);
                    qe.default.log("DC#".concat(this.connectionId, " Try to send ").concat(n.length, " chunks..."));
                    try {
                ...
                (t.prototype.handleMessage = function (e) {
                    ...
                    switch (e.type) {
                        ...
                        case ot.Candidate:
                            ...
                            break;
                        default:
                            qe.default.warn("Unrecognized message type:", e.type, "from peer:", this.peer);
                    }
                }),
                (t.ID_PREFIX = "dc_"),
        ...
        Ft = (function () {
            ...
            return (
                (e.prototype._buildRequest = function (e) {
                    ...
                    return s.searchParams.set("ts", "".concat(Date.now()).concat(Math.random())), s.searchParams.set("version", pt.version), fetch(s.href, { referrerPolicy: this._options.referrerPolicy });
                }),
                                ...
                                case 2:
                                    throw (
                                        ...
                                        "/" === this._options.path &&
                                            ...
                                            (r = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),
                                    ...
                                    if (200 !== (e = n.sent()).status) {
                                        if (401 === e.status)
                                            throw (
                                                ...
                                                new Error("It doesn't look like you have permission to list peers IDs. " + t))
                                            );
                                        throw new Error("Error. Status:".concat(e.status));
                                    }
                                    return [2, e.json()];
                                case 2:
                                    throw ((r = n.sent()), qe.default.error("Error retrieving list peers", r), new Error("Could not get list peers from the server." + r));
                                case 3:
                                    return [2];
                            }
                        });
        ...
        Jt = (function (e) {
            function t(r, n) {
                ...
                return (
                    ...
                    (n = zt({ debug: 0, host: Fe.CLOUD_HOST, port: Fe.CLOUD_PORT, path: "/", key: t.DEFAULT_KEY, token: Fe.randomToken(), config: Fe.defaultConfig, referrerPolicy: "strict-origin-when-cross-origin" }, n)),
                    (o._options = n),
                    "/" === o._options.host && (o._options.host = window.location.hostname),
                    o._options.path && ("/" !== o._options.path[0] && (o._options.path = "/" + o._options.path), "/" !== o._options.path[o._options.path.length - 1] && (o._options.path += "/")),
                    void 0 === o._options.secure && o._options.host !== Fe.CLOUD_HOST ? (o._options.secure = Fe.isSecure()) : o._options.host == Fe.CLOUD_HOST && (o._options.secure = !0),
                    o._options.logFunction && qe.default.setLogFunction(o._options.logFunction),
                    (qe.default.logLevel = o._options.debug || 0),
                    (o._api = new Lt.API(n)),
                    (o._socket = o._createServerConnection()),
                    Fe.supports.audioVideo || Fe.supports.data
                        ? i && !Fe.validateId(i)
                            ? (o._delayedAbort(rt.InvalidID, 'ID "'.concat(i, '" is invalid')), o)
                            : (i
                                  ? o._initialize(i)
                                  : o._api
                                        .retrieveId()
                              ...
                              o)
                        : (o._delayedAbort(rt.BrowserIncompatible, "The current browser does not support WebRTC"), o)
                );
            }
            return (
                Ut(t, e),
                ...
                Object.defineProperty(t.prototype, "connections", {
                    get: function () {
                        ...
                        try {
                            for (var n = Gt(this._connections), i = n.next(); !i.done; i = n.next()) {
                                var o = Vt(i.value, 2),
                                    a = o[0],
                                    s = o[1];
                                r[a] = s;
                ...
                (t.prototype._createServerConnection = function () {
                    var e = this,
                        t = new ct.Socket(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key, this._options.pingInterval);
                    return (
                        ...
                        t.on(it.Disconnected, function () {
                            e.disconnected || (e.emitError(rt.Network, "Lost connection to server."), e.disconnect());
                        }),
                        t.on(it.Close, function () {
                            e.disconnected || e._abort(rt.SocketClosed, "Underlying socket is already closed.");
                        }),
                        t
                    );
                }),
                ...
                (t.prototype._handleMessage = function (e) {
                    ...
                    switch (n) {
                        ...
                        case ot.Error:
                            ...
                            break;
                        case ot.IdTaken:
                            this._abort(rt.UnavailableID, 'ID "'.concat(this.id, '" is taken'));
                            break;
                        case ot.InvalidKey:
                            this._abort(rt.InvalidKey, 'API KEY "'.concat(this._options.key, '" is invalid'));
                            break;
                        case ot.Leave:
                        ...
                        case ot.Offer:
                            ...
                            if (((f = this.getConnection(o, a)) && (f.close(), qe.default.warn("Offer received for existing Connection ID:".concat(a))), i.type === tt.Media)) {
                                var s = new vt.MediaConnection(o, this, { connectionId: a, _payload: i, metadata: i.metadata });
                                (f = s), this._addConnection(o, f), this.emit("call", s);
                            } else {
                                if (i.type !== tt.Data) return void qe.default.warn("Received malformed connection type:".concat(i.type));
                                var c = new xt.DataConnection(o, this, { connectionId: a, _payload: i, metadata: i.metadata, label: i.label, serialization: i.serialization, reliable: i.reliable });
                            ...
                            break;
                        default:
                            if (!i) return void qe.default.warn("You received a malformed message from ".concat(o, " of type ").concat(n));
                            var f;
                            a = i.connectionId;
                            (f = this.getConnection(o, a)) && f.peerConnection ? f.handleMessage(e) : a ? this._storeMessage(a, e) : qe.default.warn("You received an unrecognized message:", e);
                    }
                }),
                ...
                (t.prototype.connect = function (e, t) {
                    if ((void 0 === t && (t = {}), this.disconnected))
                        return (
                            ...
                            void this.emitError(rt.Disconnected, "Cannot connect to new Peer after disconnecting from server.")
                        );
                ...
                (t.prototype.call = function (e, t, r) {
                    if ((void 0 === r && (r = {}), this.disconnected))
                        return (
                            qe.default.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."),
                            void this.emitError(rt.Disconnected, "Cannot connect to new Peer after disconnecting from server.")
                        );
                    if (t) {
                        var n = new vt.MediaConnection(e, this, zt(zt({}, r), { _stream: t }));
                        return this._addConnection(e, n), n;
                    }
                    qe.default.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");
                }),
                (t.prototype._addConnection = function (e, t) {
                    qe.default.log("add connection ".concat(t.type, ":").concat(t.connectionId, " to peerId:").concat(e)), this._connections.has(e) || this._connections.set(e, []), this._connections.get(e).push(t);
                }),
                ...
                (t.prototype._cleanup = function () {
                    var e, t;
                    try {
                        for (var r = Gt(this._connections.keys()), n = r.next(); !n.done; n = r.next()) {
                            var i = n.value;
                ...
                (t.prototype.disconnect = function () {
                    if (!this.disconnected) {
                        var e = this.id;
                        qe.default.log("Disconnect peer with ID:".concat(e)), (this._disconnected = !0), (this._open = !1), this.socket.close(), (this._lastServerId = e), (this._id = null), this.emit("disconnected", e);
                    }
                }),
                (t.prototype.reconnect = function () {
                    if (this.disconnected && !this.destroyed) qe.default.log("Attempting reconnection to server with ID ".concat(this._lastServerId)), (this._disconnected = !1), this._initialize(this._lastServerId);
                    else {
                        ...
                        qe.default.error("In a hurry? We're still trying to make the initial connection!");
                    }
                }),

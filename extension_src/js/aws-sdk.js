(_xamzrequire = (function () {
...
})()(
    {
            ...
            function (e, t, r) {
                (function (r) {
                    ...
                    function i(e, t) {
                        e = e || {};
                        var i;
                        if (e[t.clientConfig] && (i = n(e[t.clientConfig], { code: "InvalidConfiguration", message: 'invalid "' + t.clientConfig + '" configuration. Expect "legacy"  or "regional". Got "' + e[t.clientConfig] + '".' })))
                            return i;
                        if (!o.util.isNode()) return i;
                        if (Object.prototype.hasOwnProperty.call(r.env, t.env)) {
                            if ((i = n(r.env[t.env], { code: "InvalidEnvironmentalVariable", message: "invalid " + t.env + ' environmental variable. Expect "legacy"  or "regional". Got "' + r.env[t.env] + '".' }))) return i;
                        }
                        var s = {};
                        try {
                        ...
                        if (s && Object.prototype.hasOwnProperty.call(s, t.sharedConfig)) {
                            if ((i = n(s[t.sharedConfig], { code: "InvalidConfiguration", message: "invalid " + t.sharedConfig + ' profile config. Expect "legacy"  or "regional". Got "' + s[t.sharedConfig] + '".' }))) return i;
                        }
                        return i;
                    }
                    var o = e("./core");
            ...
            function (e, t, r) {
                ...
                ({}.toString(),
                    ...
                    n.util.update(n, {
                        VERSION: "2.596.0",
                        Signers: {},
                        Protocol: { Json: e("./protocol/json"), Query: e("./protocol/query"), Rest: e("./protocol/rest"), RestJson: e("./protocol/rest_json"), RestXml: e("./protocol/rest_xml") },
                        XML: { Builder: e("./xml/builder"), Parser: null },
                        JSON: { Builder: e("./json/builder"), Parser: e("./json/parser") },
                        Model: { Api: e("./model/api"), Operation: e("./model/operation"), Shape: e("./model/shape"), Paginator: e("./model/paginator"), ResourceWaiter: e("./model/resource_waiter") },
        ...
        119: [
            ...
            { "../util": 117, "./xml-node": 122, "./xml-text": 123 },
        ],
        123: [
            function (e, t, r) {
                function n(e) {
        ...
        109: [
            ...
            { "../core": 39, "./presign": 108, "./s3": 110, "./v2": 111, "./v3": 112, "./v3https": 113, "./v4": 114 },
        ],
        114: [
            function (e, t, r) {
                var n = e("../core"),
                ...
                (n.Signers.V4 = o(n.Signers.RequestSigner, {
                    ...
                    updateForPresigned: function (e, t) {
                        var r = this.credentialString(t),
                            i = { "X-Amz-Date": t, "X-Amz-Algorithm": this.algorithm, "X-Amz-Credential": e.accessKeyId + "/" + r, "X-Amz-Expires": this.request.headers["presigned-expires"], "X-Amz-SignedHeaders": this.signedHeaders() };
        ...
        110: [
            function (e, t, r) {
                ...
                (n.Signers.S3 = i(n.Signers.RequestSigner, {
                    ...
                    responseHeaders: { "response-content-type": 1, "response-content-language": 1, "response-expires": 1, "response-cache-control": 1, "response-content-disposition": 1, "response-content-encoding": 1 },
                    addAuthorization: function (e, t) {
            ...
            function (e, t, r) {
                function n(e) {
                    ...
                    if ((delete e.httpRequest.headers["User-Agent"], delete e.httpRequest.headers["X-Amz-User-Agent"], r === o.Signers.V4)) {
                        if (t > 604800) {
                            throw o.util.error(new Error(), { code: "InvalidExpiryTime", message: "Presigning does not support expiry time greater than a week with SigV4 signing.", retryable: !1 });
                        }
                        e.httpRequest.headers[a] = t;
                    } else {
                        if (r !== o.Signers.S3) throw o.util.error(new Error(), { message: "Presigning only supports S3 or SigV4 signing.", code: "UnsupportedSigner", retryable: !1 });
                        ...
                        apiCallEvent: function (e) {
                            ...
                            if ((n.httpResponse.statusCode && (r.FinalHttpStatusCode = n.httpResponse.statusCode), n.error)) {
                                ...
                                n.httpResponse.statusCode > 299
                                    ...
                                    : ((i.code || i.name) && (r.FinalSdkException = i.code || i.name), i.message && (r.FinalSdkExceptionMessage = i.message));
                            }
                            return r;
                        },
                        apiAttemptEvent: function (e) {
                            ...
                            return (
                                ...
                                n.httpResponse.headers
                                    ? (e.httpRequest.headers["x-amz-security-token"] && (r.SessionToken = e.httpRequest.headers["x-amz-security-token"]),
                        ...
                        attemptFailEvent: function (e) {
                            ...
                            return (
                                r.httpResponse.statusCode > 299
                                    ...
                                    : ((n.code || n.name) && (t.SdkException = n.code || n.name), n.message && (t.SdkExceptionMessage = n.message)),
                                t
                            );
                        },
        ...
        82: [
                    ...
                    for (var t = i(e), r = 0; r < t.length; r++) {
                        ...
                        if (n && Object.prototype.hasOwnProperty.call(c.rules, n)) {
                            ...
                            return (
                                ...
                                e.config.useDualstack && u.isDualstackAvailable(e) && ((s = u.copy(s)), (s.endpoint = "{service}.dualstack.{region}.amazonaws.com")),
            ...
            { "./region_config_data.json": 83, "./util": 117 },
        ],
        83: [
            function (e, t, r) {
                t.exports = {
                    rules: {
                        ...
                        "*/iam": "globalSSL",
                        "*/sts": "globalSSL",
                        "*/importexport": { endpoint: "{service}.amazonaws.com", signatureVersion: "v2", globalEndpoint: !0 },
                        "*/route53": { endpoint: "https://{service}.amazonaws.com", signatureVersion: "v3https", globalEndpoint: !0 },
                        "*/waf": "globalSSL",
                    ...
                    patterns: {
                        globalSSL: { endpoint: "https://{service}.amazonaws.com", globalEndpoint: !0 },
            ...
            function (e, t, r) {
                ...
                i.ResourceWaiter = o({
                    ...
                    setError: function (e, t) {
                        (e.data = null), (e.error = i.util.error(e.error || new Error(), { code: "ResourceNotReady", message: "Resource is not in the state " + this.state, retryable: t }));
                    },
                    loadWaiterConfig: function (e) {
                        if (!this.service.api.waiters[e]) throw new i.util.error(new Error(), { code: "StateNotFoundError", message: "State " + e + " not found." });
        ...
        84: [
                            ...
                            abort: function () {
                                return (
                                    ...
                                    this.on("validateResponse", function (e) {
                                        e.error = n.util.error(new Error("Request aborted by user"), { code: "RequestAbortedError", retryable: !1 });
                                    }),
                                ...
                                return (
                                    ...
                                    this.on("httpHeaders", function (t, o, s) {
                                        if (t < 300) {
                                            ...
                                            var l = function () {
                                                    u && c !== a
                                                        ? i.emit("error", n.util.error(new Error("Stream content length mismatch. Received " + c + " of " + a + " bytes."), { code: "StreamContentLengthMismatch" }))
                                                        : 2 === n.HttpClient.streamsApiVersion
                                                        ? i.end()
                                                        : i.emit("end");
                                                },
            ...
            { "./core": 39, "./state_machine": 116, _process: 8, jmespath: 7 },
        ],
        116: [
            function (e, t, r) {
                function n(e, t) {
                ...
                (n.prototype.runTo = function (e, t, r, n) {
                    ...
                    (n.prototype.addState = function (e, t, r, n) {
                        return (
                            "function" == typeof t ? ((n = t), (t = null), (r = null)) : "function" == typeof r && ((n = r), (r = null)), this.currentState || (this.currentState = e), (this.states[e] = { accept: t, fail: r, fn: n }), this
                        );
                    }),
                    (t.exports = n);
            },
            ...
            function (e, t, r) {
                function n(e, t) {
                    ...
                    (e = e || {}),
                        ...
                        l(this, "isApi", !0, !1),
                        l(this, "apiVersion", e.metadata.apiVersion),
                        l(this, "endpointPrefix", e.metadata.endpointPrefix),
                        l(this, "signingName", e.metadata.signingName),
                        l(this, "globalEndpoint", e.metadata.globalEndpoint),
                        l(this, "signatureVersion", e.metadata.signatureVersion),
                        l(this, "jsonVersion", e.metadata.jsonVersion),
                        l(this, "targetPrefix", e.metadata.targetPrefix),
                        l(this, "protocol", e.metadata.protocol),
                        l(this, "timestampFormat", e.metadata.timestampFormat),
                        l(this, "xmlNamespaceUri", e.metadata.xmlNamespace),
                        l(this, "abbreviation", e.metadata.serviceAbbreviation),
                        l(this, "fullName", e.metadata.serviceFullName),
                        l(this, "serviceId", e.metadata.serviceId),
                        h(this, "className", function () {
                        ...
                        t.documentation && (l(this, "documentation", e.documentation), l(this, "documentationUrl", e.documentationUrl));
                }
                var i = e("./collection"),
                    o = e("./operation"),
                    s = e("./shape"),
                    ...
                    c = e("../util"),
                    l = c.property,
                    h = c.memoizedProperty;
                t.exports = n;
            },
            { "../util": 117, "./collection": 66, "./operation": 67, "./paginator": 68, "./resource_waiter": 69, "./shape": 70 },
        ],
        69: [
            function (e, t, r) {
                function n(e, t, r) {
        ...
        60: [
                        ...
                        Core: new o().addNamedListeners(function (e, t) {
                            t("VALIDATE_CREDENTIALS", "validate", function (e, t) {
                                ...
                                e.service.config.getCredentials(function (r) {
                                    r && (e.response.error = i.util.error(r, { code: "CredentialsError", message: "Missing credentials in config" })), t();
                                });
                            }),
                                e("VALIDATE_REGION", "validate", function (e) {
                                    e.service.config.region || e.service.isGlobalEndpoint || (e.response.error = i.util.error(new Error(), { code: "ConfigError", message: "Missing region in config" }));
                                }),
                            ...
                            t("DISCOVER_ENDPOINT", "sign", s, !0),
                                    ...
                                    r.config.getCredentials(function (n, o) {
                                        ...
                                        try {
                                            var s = r.getSkewCorrectedDate(),
                                                ...
                                                u = new a(e.httpRequest, r.api.signingName || r.api.endpointPrefix, { signatureCache: r.config.signatureCache, operation: i, signatureVersion: r.api.signatureVersion });
                                ...
                                e("VALIDATE_RESPONSE", "validateResponse", function (e) {
                                    this.service.successfulResponse(e, this) ? ((e.data = {}), (e.error = null)) : ((e.data = null), (e.error = i.util.error(new Error(), { code: "UnknownError", message: "An unknown error occurred." })));
                                }),
                                t("SEND", "send", function (e, t) {
                                    ...
                                    function o(r) {
                                        if ("RequestAbortedError" !== r.code) {
                                            ...
                                            r = i.util.error(r, { code: n, region: e.request.httpRequest.region, hostname: e.request.httpRequest.endpoint.hostname, retryable: !0 });
                                        }
                                        (e.error = r),
                                ...
                                e("REDIRECT", "retry", function (e) {
                                    e.error &&
                                        ...
                                        ((this.httpRequest.endpoint = new i.Endpoint(e.httpResponse.headers.location)), (this.httpRequest.headers.Host = this.httpRequest.endpoint.host), (e.error.redirect = !0), (e.error.retryable = !0));
                                }),
                                e("RETRY_CHECK", "retry", function (e) {
                                ...
                                t("RESET_RETRY_STATE", "afterRetry", function (e, t) {
                                    var r,
                                        n = !1;
                                    e.error &&
                                        ((r = e.error.retryDelay || 0), e.error.retryable && e.retryCount < e.maxRetries ? (e.retryCount++, (n = !0)) : e.error.redirect && e.redirectCount < e.maxRedirects && (e.redirectCount++, (n = !0))),
                            ...
                            e("EXTRACT_REQUEST_ID", "extractData", i.util.extractRequestId),
                                ...
                                e("ENOTFOUND_ERROR", "httpError", function (e) {
                                    if ("NetworkingError" === e.code && "ENOTFOUND" === e.errno) {
                                        ...
                                        this.response.error = i.util.error(new Error(t), { code: "UnknownEndpoint", region: e.region, hostname: e.hostname, retryable: !0, originalError: e });
                                    }
                                });
                        }),
            ...
            { "./core": 39, "./discover_endpoint": 47, "./protocol/json": 74, "./protocol/query": 75, "./protocol/rest": 76, "./protocol/rest_json": 77, "./protocol/rest_xml": 78, "./sequential_executor": 88, util: 20 },
        ],
        88: [
            function (e, t, r) {
                var n = e("./core");
        ...
        78: [
            function (e, t, r) {
                ...
                function o(e) {
                    ...
                    t.Errors && (t = t.Errors),
                        t.Error && (t = t.Error),
                        t.Code ? (e.error = u.error(new Error(), { code: t.Code, message: t.Message })) : (e.error = u.error(new Error(), { code: e.httpResponse.statusCode, message: null }));
                }
                function s(e) {
                    c.extractData(e);
                    var t,
                    ...
                    if (s) {
                        var l = o.members[s];
                        l.isEventStream
                            ? ((t = new a.XML.Parser()), (e.data[s] = u.createEventStream(2 === a.HttpClient.streamsApiVersion ? e.httpResponse.stream : e.httpResponse.body, t, l)))
                            : "structure" === l.type
        ...
        77: [
            function (e, t, r) {
                ...
                function a(e) {
                    ...
                    if (i.payload) {
                        ...
                        if (o.isEventStream) (t = new p()), (e.data[payload] = u.createEventStream(2 === AWS.HttpClient.streamsApiVersion ? e.httpResponse.stream : s, t, o));
            ...
            { "../json/builder": 63, "../json/parser": 64, "../util": 117, "./json": 74, "./rest": 76 },
        ],
        76: [
            function (e, t, r) {
                function n(e) {
        ...
        75: [
            function (e, t, r) {
                ...
                function i(e) {
                    ...
                    if (r.match("<UnknownOperationException")) t = { Code: "UnknownOperation", Message: "Unknown operation " + e.request.operation };
                    else
                        try {
                    ...
                    t.requestId && !e.requestId && (e.requestId = t.requestId),
                        t.Errors && (t = t.Errors),
                        t.Error && (t = t.Error),
                        t.Code ? (e.error = a.error(new Error(), { code: t.Code, message: t.Message })) : (e.error = a.error(new Error(), { code: e.httpResponse.statusCode, message: null }));
                }
                function o(e) {
                    var t = e.request,
                    ...
                    (e.requestId = h._XAMZRequestId || h.requestId), h._XAMZRequestId && delete h._XAMZRequestId, i.resultWrapper && h[i.resultWrapper] && (a.update(h, h[i.resultWrapper]), delete h[i.resultWrapper]), (e.data = h);
                }
                var s = e("../core"),
                    a = e("../util"),
            ...
            { "../core": 39, "../model/shape": 70, "../query/query_param_serializer": 79, "../util": 117, "./helpers": 73 },
        ],
        79: [
            function (e, t, r) {
                function n() {}
        ...
        70: [
            function (e, t, r) {
                ...
                function a(e, t) {
                    ...
                    s.apply(this, arguments),
                        ...
                        "string" == typeof e.xmlNamespace
                            ...
                            : "object" == typeof e.xmlNamespace && (n(this, "xmlNamespacePrefix", e.xmlNamespace.prefix), n(this, "xmlNamespaceUri", e.xmlNamespace.uri));
                }
                function u(e, t) {
                    var r = this,
                        a = !this.isShape;
                ...
                var g = e("./collection"),
                    y = e("../util");
                (o.normalizedTypes = { character: "string", double: "float", long: "integer", short: "integer", biginteger: "integer", bigdecimal: "float", blob: "binary" }),
                    (o.types = { structure: a, list: u, map: c, boolean: v, timestamp: l, float: p, integer: f, string: h, base64: m, binary: d }),
                    ...
                    (o.shapes = { StructureShape: a, ListShape: u, MapShape: c, StringShape: h, BooleanShape: v, Base64Shape: m }),
                    (t.exports = o);
            },
            { "../util": 117, "./collection": 66 },
        ],
        66: [
            function (e, t, r) {
                function n(e, t, r, n) {
        ...
        74: [
            function (e, t, r) {
                ...
                function i(e) {
                    var t = {},
                        r = e.httpResponse;
                    if (((t.code = r.headers["x-amzn-errortype"] || "UnknownError"), "string" == typeof t.code && (t.code = t.code.split(":")[0]), r.body.length > 0))
                        try {
            ...
            { "../json/builder": 63, "../json/parser": 64, "../util": 117, "./helpers": 73 },
        ],
        73: [
            function (e, t, r) {
                function n(e) {
                ...
                function o(e, t, r) {
                    return (
                        u.each(r.members, function (r, n) {
                            if (!0 === n.hostLabel) {
                                if ("string" != typeof t[r] || "" === t[r]) throw u.error(new Error(), { message: "Parameter " + r + " should be a non-empty string.", code: "InvalidParameter" });
                ...
                function a(e) {
                    ...
                    u.arrayEach(t, function (e) {
                        if (!e.length || e.length < 1 || e.length > 63) throw u.error(new Error(), { code: "ValidationError", message: "Hostname label length should be between 1 to 63 characters, inclusive." });
                        if (!r.test(e)) throw c.util.error(new Error(), { code: "ValidationError", message: e + " is not hostname compatible." });
                    });
                }
                var u = e("../util"),
                    c = e("../core");
                        ...
                        if (!l || 1 !== l.length || "" !== l[0].Address)
                            if (l && l.length > 0) e.httpRequest.updateEndpoint(l[0].Address);
                                ...
                                u(h),
                                    ...
                                    h.send(function (e, t) {
                                        t && t.Endpoints ? d.endpointCache.put(c, t.Endpoints) : e && d.endpointCache.put(c, [{ Address: "", CachePeriodInMinutes: 1 }]);
                                    });
                            }
                    }
                    function a(e, t) {
                        ...
                        if (p && p.length > 0) e.httpRequest.updateEndpoint(p[0].Address), t();
                            ...
                            f.removeListener("validate", d.EventListeners.Core.VALIDATE_PARAMETERS),
                                ...
                                f.send(function (r, n) {
                                    if (r) {
                                        var i = { code: "EndpointDiscoveryException", message: "Request cannot be fulfilled without specifying an endpoint", retryable: !1 };
                                        if (((e.response.error = m.error(r, i)), d.endpointCache.remove(l), g[h])) {
                                            var o = g[h];
                                    ...
                                    } else if (n && (d.endpointCache.put(h, n.Endpoints), e.httpRequest.updateEndpoint(n.Endpoints[0].Address), g[h])) {
                                        var o = g[h];
                                        m.arrayEach(o, function (e) {
                    ...
                    function p(e) {
                        ...
                        for (var t = 0; t < v.length; t++) {
                            ...
                            if (Object.prototype.hasOwnProperty.call(r.env, n)) {
                                if ("" === r.env[n] || void 0 === r.env[n]) throw m.error(new Error(), { code: "ConfigurationException", message: "environmental variable " + n + " cannot be set to nothing" });
                                if (!h(r.env[n])) return !0;
                            }
                        }
                        var i = {};
                        try {
                            i = d.util.iniLoader ? d.util.iniLoader.loadFrom({ isConfig: !0, filename: r.env[d.util.sharedConfigFileEnv] }) : {};
                        } catch (e) {}
                        var o = i[r.env.AWS_PROFILE || d.util.defaultProfile] || {};
                        if (Object.prototype.hasOwnProperty.call(o, "endpoint_discovery_enabled")) {
                            if (void 0 === o.endpoint_discovery_enabled) throw m.error(new Error(), { code: "ConfigurationException", message: "config file entry 'endpoint_discovery_enabled' cannot be set to nothing" });
                            if (!h(o.endpoint_discovery_enabled)) return !0;
                        }
                        return !1;
                    }
                    function f(e, t) {
        ...
        117: [
                        ...
                        o = {
                            ...
                            crypto: {
                                ...
                                hash: function (e, t, r, n) {
                                    ...
                                    if ((o.isBrowser() && "undefined" != typeof ArrayBuffer && t && t.buffer instanceof ArrayBuffer && (a = !0), n && "object" == typeof t && "function" == typeof t.on && !a))
                            ...
                            error: function (e, t) {
                                var r = null;
                                return (
                                    "string" == typeof e.message && "" !== e.message && ("string" == typeof t || (t && t.message)) && ((r = o.copy(e)), (r.message = e.message)),
                                    (e.message = e.message || null),
                                    "string" == typeof t
                                        ? (e.message = t)
                                        : "object" == typeof t && null !== t && (o.update(e, t), t.message && (e.message = t.message), (t.code || t.name) && (e.code = t.code || t.name), t.stack && (e.stack = t.stack)),
                                    "function" == typeof Object.defineProperty && (Object.defineProperty(e, "name", { writable: !0, enumerable: !1 }), Object.defineProperty(e, "message", { enumerable: !0 })),
                            ...
                            getProfilesFromSharedConfig: function (e, t) {
                                var n = {},
                                    i = {};
                                if (r.env[o.configOptInEnv]) var i = e.loadFrom({ isConfig: !0, filename: r.env[o.sharedConfigFileEnv] });
                                for (var s = e.loadFrom({ filename: t || (r.env[o.configOptInEnv] && r.env[o.sharedCredentialsFileEnv]) }), a = 0, u = Object.keys(i); a < u.length; a++) n[u[a]] = i[u[a]];
                                for (var a = 0, u = Object.keys(s); a < u.length; a++) n[u[a]] = s[u[a]];
                                return n;
                            },
                            ARN: {
                                validate: function (e) {
            ...
            { "../apis/metadata.json": 26, "./core": 39, _process: 8, fs: 2, timers: 16, uuid: 21 },
        ],
        37: [
            function (e, t, r) {
                var n = e("./core");
                ...
                (n.Config = n.util.inherit({
                    ...
                    getCredentials: function (e) {
                        ...
                        function r(e, t) {
                            return new n.util.error(t || new Error(), { code: "CredentialsError", message: e, name: "CredentialsError" });
                        }
                        var i = this;
                        i.credentials
            ...
            { "./core": 39, "./credentials": 40, "./credentials/credential_provider_chain": 43 },
        ],
        43: [
            function (e, t, r) {
                var n = e("../core");
        ...
        26: [
            function (e, t, r) {
                t.exports = {
                    ...
                    applicationautoscaling: { prefix: "application-autoscaling", name: "ApplicationAutoScaling", cors: !0 },
                    ...
                    cloudwatchevents: { prefix: "events", name: "CloudWatchEvents", versions: ["2014-02-03*"], cors: !0 },
                    ...
                    cognitoidentityserviceprovider: { prefix: "cognito-idp", name: "CognitoIdentityServiceProvider", cors: !0 },
                    ...
                    elasticache: { name: "ElastiCache", versions: ["2012-11-15*", "2014-03-24*", "2014-07-15*", "2014-09-30*"], cors: !0 },
                    ...
                    s3control: { name: "S3Control", dualstackAvailable: !0 },
                    ...
                    lexmodelbuildingservice: { prefix: "lex-models", name: "LexModelBuildingService", cors: !0 },
                    marketplaceentitlementservice: { prefix: "entitlement.marketplace", name: "MarketplaceEntitlementService" },
                    athena: { name: "Athena" },
                    ...
                    kinesisvideoarchivedmedia: { prefix: "kinesis-video-archived-media", name: "KinesisVideoArchivedMedia", cors: !0 },
                    ...
                    cloud9: { name: "Cloud9" },
                    serverlessapplicationrepository: { prefix: "serverlessrepo", name: "ServerlessApplicationRepository" },
                    ...
                    personalizeruntime: { prefix: "personalize-runtime", name: "PersonalizeRuntime", cors: !0 },
                    ...
                    codestarnotifications: { prefix: "codestar-notifications", name: "CodeStarNotifications" },
                    savingsplans: { name: "SavingsPlans" },
                    sso: { name: "SSO" },
                    ssooidc: { prefix: "sso-oidc", name: "SSOOIDC" },
                    marketplacecatalog: { prefix: "marketplace-catalog", name: "MarketplaceCatalog" },
                    ...
                    ebs: { name: "EBS" },
                    kinesisvideosignalingchannels: { prefix: "kinesis-video-signaling", name: "KinesisVideoSignalingChannels", cors: !0 },
        ...
        24: [
            function (e, t, r) {
                function n(e, t, r) {
                    ...
                    (l[n++] = (y >>> 8) & 255), (l[n++] = 255 & y), (l[n++] = ((y >>> 24) & 15) | 16), (l[n++] = (y >>> 16) & 255), (l[n++] = (p >>> 8) | 128), (l[n++] = 255 & p);
            ...
            function (e, t, r) {
                (function (t, n) {
                    ...
                    function u(e, t, n) {
                        ...
                        var s = Object.keys(t),
                            m = a(s);
                        if ((e.showHidden && (s = Object.getOwnPropertyNames(t)), x(t) && (s.indexOf("message") >= 0 || s.indexOf("description") >= 0))) return l(t);
                        if (0 === s.length) {
                            if (R(t)) {
                                var v = t.name ? ": " + t.name : "";
                        ...
                        if ((_(t) && (g = " " + RegExp.prototype.toString.call(t)), C(t) && (g = " " + Date.prototype.toUTCString.call(t)), x(t) && (g = " " + l(t)), 0 === s.length && (!y || 0 == t.length))) return w[0] + g + w[1];
                    ...
                    (r.debuglog = function (e) {
                        ...
                        (i.styles = { special: "cyan", number: "yellow", boolean: "yellow", undefined: "grey", null: "bold", string: "green", date: "magenta", regexp: "red" }),
                        (r.isArray = d),
                        (r.isBoolean = m),
                        (r.isNull = v),
            ...
            function (e, t, r) {
                !(function (e) {
                    ...
                    function p(e) {
                        (this._interpreter = e),
                            (this.functionTable = {
                                ...
                                ceil: { _func: this._functionCeil, _signature: [{ types: [g] }] },
                                contains: { _func: this._functionContains, _signature: [{ types: [b, w] }, { types: [y] }] },
                                ends_with: { _func: this._functionEndsWith, _signature: [{ types: [b] }, { types: [b] }] },
                                floor: { _func: this._functionFloor, _signature: [{ types: [g] }] },
                                ...
                                max_by: { _func: this._functionMaxBy, _signature: [{ types: [w] }, { types: [_] }] },
                                sum: { _func: this._functionSum, _signature: [{ types: [S] }] },
                                starts_with: { _func: this._functionStartsWith, _signature: [{ types: [b] }, { types: [b] }] },
                                min: { _func: this._functionMin, _signature: [{ types: [S, C] }] },
                                min_by: { _func: this._functionMinBy, _signature: [{ types: [w] }, { types: [_] }] },
                                ...
                                sort_by: { _func: this._functionSortBy, _signature: [{ types: [w] }, { types: [_] }] },
                                ...
                                not_null: { _func: this._functionNotNull, _signature: [{ types: [y], variadic: !0 }] },
                            });
                    }
                    function f(e) {
                    ...
                    var g = 0,
                        ...
                        S = 8,
                        C = 9,
                        x = { ".": "Dot", "*": "Star", ",": "Comma", ":": "Colon", "{": "Lbrace", "}": "Rbrace", "]": "Rbracket", "(": "Lparen", ")": "Rparen", "@": "Current" },
                        R = { "<": !0, ">": !0, "=": !0, "!": !0 },
                        A = { " ": !0, "\t": !0, "\n": !0 };
                    c.prototype = {
                        tokenize: function (e) {
                            ...
                            for (var r, n, i; this._current < e.length; )
                                if (s(e[this._current])) (r = this._current), (n = this._consumeUnquotedIdentifier(e)), t.push({ type: "UnquotedIdentifier", value: n, start: r });
                                else if (void 0 !== x[e[this._current]]) t.push({ type: x[e[this._current]], value: e[this._current], start: this._current }), this._current++;
                                else if (a(e[this._current])) (i = this._consumeNumber(e)), t.push(i);
                                else if ("[" === e[this._current]) (i = this._consumeLBracket(e)), t.push(i);
                                else if ('"' === e[this._current]) (r = this._current), (n = this._consumeQuotedIdentifier(e)), t.push({ type: "QuotedIdentifier", value: n, start: r });
                                else if ("'" === e[this._current]) (r = this._current), (n = this._consumeRawStringLiteral(e)), t.push({ type: "Literal", value: n, start: r });
                                    ...
                                    (r = this._current), this._current++, "&" === e[this._current] ? (this._current++, t.push({ type: "And", value: "&&", start: r })) : t.push({ type: "Expref", value: "&", start: r });
                                else {
                                    if ("|" !== e[this._current]) {
                                        var u = new Error("Unknown character:" + e[this._current]);
                                        throw ((u.name = "LexerError"), u);
                                    }
                                    (r = this._current), this._current++, "|" === e[this._current] ? (this._current++, t.push({ type: "Or", value: "||", start: r })) : t.push({ type: "Pipe", value: "|", start: r });
                                }
                            return t;
                        },
                        ...
                        (l.prototype = {
                            ...
                            nud: function (e) {
                                ...
                                switch (e.type) {
                                    ...
                                    case "Star":
                                        return (t = { type: "Identity" }), (r = null), (r = "Rbracket" === this._lookahead(0) ? { type: "Identity" } : this._parseProjectionRHS(T.Star)), { type: "ValueProjection", children: [t, r] };
                                    case "Filter":
                                        return this.led(e.type, { type: "Identity" });
                                    case "Lbrace":
                                        return this._parseMultiselectHash();
                                    case "Flatten":
                                        return (t = { type: "Flatten", children: [{ type: "Identity" }] }), (r = this._parseProjectionRHS(T.Flatten)), { type: "Projection", children: [t, r] };
                                    case "Lbracket":
                                        return "Number" === this._lookahead(0) || "Colon" === this._lookahead(0)
                                            ...
                                            ? (this._advance(), this._advance(), (r = this._parseProjectionRHS(T.Star)), { type: "Projection", children: [{ type: "Identity" }, r] })
                                    ...
                                    case "Lparen":
                                        for (var o = []; "Rparen" !== this._lookahead(0); ) "Current" === this._lookahead(0) ? ((n = { type: "Current" }), this._advance()) : (n = this.expression(0)), o.push(n);
                                ...
                                switch (e) {
                                    ...
                                    case "Lparen":
                                        for (var i, o = t.name, s = []; "Rparen" !== this._lookahead(0); )
                                            "Current" === this._lookahead(0) ? ((i = { type: "Current" }), this._advance()) : (i = this.expression(0)), "Comma" === this._lookahead(0) && this._match("Comma"), s.push(i);
                                        return this._match("Rparen"), { type: "Function", name: o, children: s };
                                    case "Filter":
                                        var a = this.expression(0);
                                        return this._match("Rbracket"), (r = "Flatten" === this._lookahead(0) ? { type: "Identity" } : this._parseProjectionRHS(T.Filter)), { type: "FilterProjection", children: [t, r, a] };
                                    case "Flatten":
                                        return { type: "Projection", children: [{ type: "Flatten", children: [t] }, this._parseProjectionRHS(T.Flatten)] };
                                    case "EQ":
                                    case "NE":
                                    case "GT":
                                    case "GTE":
                                    ...
                                    case "Lbracket":
                                        ...
                                        return "Number" === u.type || "Colon" === u.type
                                            ...
                                            : (this._match("Star"), this._match("Rbracket"), (r = this._parseProjectionRHS(T.Star)), { type: "Projection", children: [t, r] });
                                    default:
                            ...
                            _projectIfSlice: function (e, t) {
                                ...
                                return "Slice" === t.type ? { type: "Projection", children: [r, this._parseProjectionRHS(T.Star)] } : r;
                            },
                            ...
                            _parseMultiselectHash: function () {
                                for (var e, t, r, n, i = [], o = ["UnquotedIdentifier", "QuotedIdentifier"]; ; ) {
                                    ...
                                    if (((t = e.value), this._advance(), this._match("Colon"), (r = this.expression(0)), (n = { type: "KeyValuePair", name: t, value: r }), i.push(n), "Comma" === this._lookahead(0))) this._match("Comma");
    ...
    (_xamzrequire = (function e(t, r, n) {
    ...
    })(
        {
                        ...
                        try {
                            if (window.DOMParser) {
                                try {
                                    ...
                                    throw h.error(new Error("Parse error in document"), { originalError: e, code: "XMLParserError", retryable: !0 });
                                }
                                if (null === r.documentElement) throw h.error(new Error("Cannot parse empty document."), { code: "XMLParserError", retryable: !0 });
                                ...
                                if (((r = new window.ActiveXObject("Microsoft.XMLDOM")), (r.async = !1), !r.loadXML(e))) throw h.error(new Error("Parse error in document"), { code: "XMLParserError", retryable: !0 });
                            }
                        } catch (e) {
                            n = e;
                        }
                                    ...
                                    l.addEventListener(
                                        ...
                                        function () {
                                            ...
                                            this.readyState >= this.HEADERS_RECEIVED &&
                                                !h &&
                                                ((u.statusCode = l.status), (u.headers = s.parseHeaders(l.getAllResponseHeaders())), u.emit("headers", u.statusCode, u.headers, l.statusText), (h = !0)),
                        ...
                        for (var t = {}, r = 0; r < e.length; ) {
                            ...
                            switch (((r += n), e.readUInt8(r++))) {
                                ...
                                case 7:
                                    ...
                                    break;
                                case 8:
                                    (t[i] = { type: d, value: new Date(new o(e.slice(r, r + 8)).valueOf()) }), (r += 8);
                                    break;
                                case 9:
                                    var g = e.slice(r, r + 16).toString("hex");
                                    (r += 16), (t[i] = { type: m, value: g.substr(0, 8) + "-" + g.substr(8, 4) + "-" + g.substr(12, 4) + "-" + g.substr(16, 4) + "-" + g.substr(20) });
                                    break;
                                default:
                ...
                function (e, t, r) {
                    ...
                    n.ChainableTemporaryCredentials = n.util.inherit(n.Credentials, {
                        constructor: function (e) {
                            ...
                            var r = n.util.merge({ params: t, credentials: e.masterCredentials || n.config.credentials }, e.stsConfig || {});
            ...
            29: [
                ...
                { "./browserHmac": 31, "./browserMd5": 32, "./browserSha1": 33, "./browserSha256": 34 },
            ],
            34: [
                function (e, t, r) {
                    function n() {
                    ...
                    (t.exports = n),
                        ...
                        (n.prototype.hashBuffer = function () {
                            for (var e = this, t = e.buffer, r = e.state, n = r[0], i = r[1], o = r[2], a = r[3], u = r[4], c = r[5], l = r[6], h = r[7], p = 0; p < 64; p++) {
                                ...
                                var v = ((((((u >>> 6) | (u << 26)) ^ ((u >>> 11) | (u << 21)) ^ ((u >>> 25) | (u << 7))) + ((u & c) ^ (~u & l))) | 0) + ((h + ((s[p] + this.temp[p]) | 0)) | 0)) | 0,
            ...
            32: [
                function (e, t, r) {
                    function n() {
                        (this.state = [1732584193, 4023233417, 2562383102, 271733878]), (this.buffer = new DataView(new ArrayBuffer(h))), (this.bufferLength = 0), (this.bytesHashed = 0), (this.finished = !1);
                    }
                    ...
                    (t.exports = n),
                        ...
                        (n.prototype.update = function (e) {
                            ...
                            var t = c.convertToBuffer(e),
                                r = 0,
                                n = t.byteLength;
                            for (this.bytesHashed += n; n > 0; ) this.buffer.setUint8(this.bufferLength++, t[r++]), n--, this.bufferLength === h && (this.hashBuffer(), (this.bufferLength = 0));
                            return this;
                        }),
                        (n.prototype.digest = function (e) {
                            if (!this.finished) {
                                ...
                                r.setUint32(h - 8, o >>> 0, !0), r.setUint32(h - 4, Math.floor(o / 4294967296), !0), this.hashBuffer(), (this.finished = !0);
                            }
            ...
            17: [
                function (e, t, r) {
                    ...
                    (n.prototype.parse = function (e, t, r) {
                                    ...
                                    if (A && !A.match(w)) {
                                        ...
                                        if (!T.match(w)) {
                                            var L = v.slice(0, c),
                                                P = v.slice(c + 1),
                                                q = A.match(E);
                                            q && (L.push(q[1]), P.unshift(q[2])), P.length && (n = "/" + P.join(".") + n), (this.hostname = L.join("."));
                                            break;
                                        }
                                    }
                                }
                        ...
                        var H = n.indexOf("?");
                        if (
                            (-1 !== H ? ((this.search = n.substr(H)), (this.query = n.substr(H + 1)), t && (this.query = x.parse(this.query)), (n = n.slice(0, H))) : t && ((this.search = ""), (this.query = {})),
                            n && (this.pathname = n),
                        ...
                        (n.prototype.resolveObject = function (e) {
                            ...
                            if (
                                (m &&
                                    ...
                                    (r.host = ""),
                                    e.protocol && ((e.hostname = null), (e.port = null), e.host && ("" === i[0] ? (i[0] = e.host) : i.unshift(e.host)), (e.host = null)),
                                    (p = p && ("" === i[0] || "" === d[0]))),
                                c)
                            )
                                (r.host = e.host || "" === e.host ? e.host : r.host), (r.hostname = e.hostname || "" === e.hostname ? e.hostname : r.hostname), (r.search = e.search), (r.query = e.query), (d = i);
                        ...
                        !(function (n) {
                            ...
                            function p(e) {
                                ...
                                for (o = r > 0 ? r + 1 : 0; o < v; ) {
                                    for (
                                        s = g, a = 1, l = _;
                                        o >= v && i("invalid-input"), (p = c(e.charCodeAt(o++))), (p >= _ || p > U((E - g) / a)) && i("overflow"), (g += p * a), (f = l <= b ? S : l >= b + C ? C : l - b), !(p < f);
                                        l += _
                                    )
                                        (d = _ - f), a > U(E / d) && i("overflow"), (a *= d);
                                    (t = m.length + 1), (b = h(g - s, t, 0 == s)), U(g / t) > E - y && i("overflow"), (y += U(g / t)), (g %= t), m.splice(g++, 0, y);
                                }
                                return u(m);
                            }
                            function f(e) {
                                ...
                                for (n = o = w.length, o && w.push(k); n < v; ) {
                                    ...
                                    for (g = n + 1, c - t > U((E - r) / g) && i("overflow"), r += (c - t) * g, t = c, u = 0; u < v; ++u)
                                        if (((m = e[u]), m < t && ++r > E && i("overflow"), m == t)) {
                                            for (p = r, f = _; (d = f <= s ? S : f >= s + C ? C : f - s), !(p < d); f += _) (b = p - d), (y = _ - d), w.push(N(l(d + (b % y), 0))), (p = U(b / y));
                                            w.push(N(l(p, 0))), (s = h(r, g, n == o)), (r = 0), ++n;
                                        }
                                    ++r, ++t;
                                }
                                return w.join("");
                ...
                function (e, t, r) {
                    (function (t, n) {
                        ...
                        function s(e, t, r, n) {
                            ...
                            return "undefined" != typeof ArrayBuffer && t instanceof ArrayBuffer ? p(e, t, r, n) : "string" == typeof t ? l(e, t, r) : f(e, t);
                        }
                        function a(e) {
                        ...
                        function p(e, t, r, i) {
                            ...
                            return (t = void 0 === r && void 0 === i ? new Uint8Array(t) : void 0 === i ? new Uint8Array(t, r) : new Uint8Array(t, r, i)), n.TYPED_ARRAY_SUPPORT ? ((e = t), (e.__proto__ = n.prototype)) : (e = h(e, t)), e;
                        }
                        function f(e, t) {
                            if (n.isBuffer(t)) {
                                var r = 0 | d(t.length);
                                    ...
                                    switch (a) {
                                        ...
                                        case 4:
                                            (u = e[i + 1]),
                                                (c = e[i + 2]),
                                                (l = e[i + 3]),
                                                128 == (192 & u) && 128 == (192 & c) && 128 == (192 & l) && (h = ((15 & o) << 18) | ((63 & u) << 12) | ((63 & c) << 6) | (63 & l)) > 65535 && h < 1114112 && (s = h);
                                    }
                                }
                        ...
                        function j(e, t, r, n, i) {
                            return i || M(e, t, r, 4, 3.4028234663852886e38, -3.4028234663852886e38), $.write(e, t, r, n, 23, 4), r + 4;
                        }
                        function B(e, t, r, n, i) {
                            return i || M(e, t, r, 8, 1.7976931348623157e308, -1.7976931348623157e308), $.write(e, t, r, n, 52, 8), r + 8;
                        }
                        function F(e) {
                        ...
                        (r.Buffer = n),
                            ...
                            n.TYPED_ARRAY_SUPPORT &&
                                ...
                                "undefined" != typeof Symbol && Symbol.species && n[Symbol.species] === n && Object.defineProperty(n, Symbol.species, { value: null, configurable: !0 })),
                            ...
                            (n.prototype.compare = function (e, t, r, i, o) {
                                if (!n.isBuffer(e)) throw new TypeError("Argument must be a Buffer");
                                if ((void 0 === t && (t = 0), void 0 === r && (r = e ? e.length : 0), void 0 === i && (i = 0), void 0 === o && (o = this.length), t < 0 || r > e.length || i < 0 || o > this.length))
                                    throw new RangeError("out of range index");
                                if (i >= o && t >= r) return 0;
                                if (i >= o) return -1;
                                if (t >= r) return 1;
                                if (((t >>>= 0), (r >>>= 0), (i >>>= 0), (o >>>= 0), this === e)) return 0;
                                for (var s = o - i, a = r - t, u = Math.min(s, a), c = this.slice(i, o), l = e.slice(t, r), h = 0; h < u; ++h)
                                    if (c[h] !== l[h]) {
                                        (s = c[h]), (a = l[h]);
                                        break;
                                    }
                        ...
                        (n.prototype.slice = function (e, t) {
                            ...
                            var i;
                            if (n.TYPED_ARRAY_SUPPORT) (i = this.subarray(e, t)), (i.__proto__ = n.prototype);
                            else {
                                var o = t - e;
                                i = new n(o, void 0);
                            ...
                            (n.prototype.readFloatLE = function (e, t) {
                                return t || O(e, 4, this.length), $.read(this, e, !0, 23, 4);
                            }),
                            (n.prototype.readFloatBE = function (e, t) {
                                return t || O(e, 4, this.length), $.read(this, e, !1, 23, 4);
                            }),
                            (n.prototype.readDoubleLE = function (e, t) {
                                return t || O(e, 8, this.length), $.read(this, e, !0, 52, 8);
                            }),
                            (n.prototype.readDoubleBE = function (e, t) {
                                return t || O(e, 8, this.length), $.read(this, e, !1, 52, 8);
                            }),
                            ...
                            (n.prototype.writeUInt8 = function (e, t, r) {
                                return (e = +e), (t |= 0), r || U(this, e, t, 1, 255, 0), n.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)), (this[t] = 255 & e), t + 1;
                            }),
                            (n.prototype.writeUInt16LE = function (e, t, r) {
                                return (e = +e), (t |= 0), r || U(this, e, t, 2, 65535, 0), n.TYPED_ARRAY_SUPPORT ? ((this[t] = 255 & e), (this[t + 1] = e >>> 8)) : N(this, e, t, !0), t + 2;
                            }),
                            (n.prototype.writeUInt16BE = function (e, t, r) {
                                return (e = +e), (t |= 0), r || U(this, e, t, 2, 65535, 0), n.TYPED_ARRAY_SUPPORT ? ((this[t] = e >>> 8), (this[t + 1] = 255 & e)) : N(this, e, t, !1), t + 2;
                            }),
                            ...
                            (n.prototype.writeInt8 = function (e, t, r) {
                                return (e = +e), (t |= 0), r || U(this, e, t, 1, 127, -128), n.TYPED_ARRAY_SUPPORT || (e = Math.floor(e)), e < 0 && (e = 255 + e + 1), (this[t] = 255 & e), t + 1;
                            }),
                            (n.prototype.writeInt16LE = function (e, t, r) {
                                return (e = +e), (t |= 0), r || U(this, e, t, 2, 32767, -32768), n.TYPED_ARRAY_SUPPORT ? ((this[t] = 255 & e), (this[t + 1] = e >>> 8)) : N(this, e, t, !0), t + 2;
                            }),
                            (n.prototype.writeInt16BE = function (e, t, r) {
                                return (e = +e), (t |= 0), r || U(this, e, t, 2, 32767, -32768), n.TYPED_ARRAY_SUPPORT ? ((this[t] = e >>> 8), (this[t + 1] = 255 & e)) : N(this, e, t, !1), t + 2;
                            }),
                                ...
                                t = Math.abs(t),
                                    isNaN(t) || t === 1 / 0
                                        ...
                                        : ((s = Math.floor(Math.log(t) / Math.LN2)),
                                          ...
                                          t * u >= 2 && (s++, (u /= 2)),
                                          s + h >= l ? ((a = 0), (s = l)) : s + h >= 1 ? ((a = (t * u - 1) * Math.pow(2, i)), (s += h)) : ((a = t * Math.pow(2, h - 1) * Math.pow(2, i)), (s = 0)));
                                i >= 8;
                ...
                function (e, t, r) {
                    ...
                    function s(e) {
                        var t,
                            ...
                            l = a > 0 ? s - 4 : s;
                        for (r = 0; r < l; r += 4)
                            (t = (h[e.charCodeAt(r)] << 18) | (h[e.charCodeAt(r + 1)] << 12) | (h[e.charCodeAt(r + 2)] << 6) | h[e.charCodeAt(r + 3)]), (u[c++] = (t >> 16) & 255), (u[c++] = (t >> 8) & 255), (u[c++] = 255 & t);
                        return (
                            2 === a && ((t = (h[e.charCodeAt(r)] << 2) | (h[e.charCodeAt(r + 1)] >> 4)), (u[c++] = 255 & t)),
                            1 === a && ((t = (h[e.charCodeAt(r)] << 10) | (h[e.charCodeAt(r + 1)] << 4) | (h[e.charCodeAt(r + 2)] >> 2)), (u[c++] = (t >> 8) & 255), (u[c++] = 255 & t)),
                            u
                        );
                    }
                    function a(e) {
                ...
                function (e, t, r) {
                    ...
                    i.Polly.Presigner = i.util.inherit({
                        ...
                        modifyInputMembers: function (e) {
                            var t = i.util.copy(e);
                            return (
                                (t.members = i.util.copy(e.members)),
                                i.util.each(e.members, function (e, r) {
                        ...
                        getSynthesizeSpeechUrl: function (e, t, r) {
                            ...
                            return (
                                o.removeAllListeners("build"),
                                o.on("build", function (e) {
...
AWS.apiLoader.services.polly["2016-06-10"] = {
    version: "2.0",
    metadata: { apiVersion: "2016-06-10", endpointPrefix: "polly", protocol: "rest-json", serviceFullName: "Amazon Polly", serviceId: "Polly", signatureVersion: "v4", uid: "polly-2016-06-10" },
    operations: {
        DeleteLexicon: {
            http: { method: "DELETE", requestUri: "/v1/lexicons/{LexiconName}", responseCode: 200 },
            input: { type: "structure", required: ["Name"], members: { Name: { shape: "S2", location: "uri", locationName: "LexiconName" } } },
            output: { type: "structure", members: {} },
        },
        DescribeVoices: {
            http: { method: "GET", requestUri: "/v1/voices", responseCode: 200 },
            input: {
                type: "structure",
                members: {
                    Engine: { location: "querystring", locationName: "Engine" },
                    LanguageCode: { location: "querystring", locationName: "LanguageCode" },
                    IncludeAdditionalLanguageCodes: { location: "querystring", locationName: "IncludeAdditionalLanguageCodes", type: "boolean" },
            ...
            output: {
                ...
                members: {
                    Voices: {
                        type: "list",
                        member: { type: "structure", members: { Gender: {}, Id: {}, LanguageCode: {}, LanguageName: {}, Name: {}, AdditionalLanguageCodes: { type: "list", member: {} }, SupportedEngines: { type: "list", member: {} } } },
                    },
                    NextToken: {},
                },
            },
        ...
        GetLexicon: {
            http: { method: "GET", requestUri: "/v1/lexicons/{LexiconName}", responseCode: 200 },
            input: { type: "structure", required: ["Name"], members: { Name: { shape: "S2", location: "uri", locationName: "LexiconName" } } },
            output: { type: "structure", members: { Lexicon: { type: "structure", members: { Content: {}, Name: { shape: "S2" } } }, LexiconAttributes: { shape: "Sm" } } },
        },
        GetSpeechSynthesisTask: {
            http: { method: "GET", requestUri: "/v1/synthesisTasks/{TaskId}", responseCode: 200 },
            input: { type: "structure", required: ["TaskId"], members: { TaskId: { location: "uri", locationName: "TaskId" } } },
            output: { type: "structure", members: { SynthesisTask: { shape: "Sv" } } },
        },
        ListLexicons: {
            http: { method: "GET", requestUri: "/v1/lexicons", responseCode: 200 },
            input: { type: "structure", members: { NextToken: { location: "querystring", locationName: "NextToken" } } },
            output: { type: "structure", members: { Lexicons: { type: "list", member: { type: "structure", members: { Name: { shape: "S2" }, Attributes: { shape: "Sm" } } } }, NextToken: {} } },
        },
        ListSpeechSynthesisTasks: {
            http: { method: "GET", requestUri: "/v1/synthesisTasks", responseCode: 200 },
            input: {
                type: "structure",
                members: {
                    MaxResults: { location: "querystring", locationName: "MaxResults", type: "integer" },
                    NextToken: { location: "querystring", locationName: "NextToken" },
                    Status: { location: "querystring", locationName: "Status" },
                },
            },
            output: { type: "structure", members: { NextToken: {}, SynthesisTasks: { type: "list", member: { shape: "Sv" } } } },
        },
        PutLexicon: {
            http: { method: "PUT", requestUri: "/v1/lexicons/{LexiconName}", responseCode: 200 },
            input: { type: "structure", required: ["Name", "Content"], members: { Name: { shape: "S2", location: "uri", locationName: "LexiconName" }, Content: {} } },
            output: { type: "structure", members: {} },
        },
        ...
        SynthesizeSpeech: {
            ...
            input: {
                ...
                members: { Engine: {}, LanguageCode: {}, LexiconNames: { shape: "S12" }, OutputFormat: {}, SampleRate: {}, SpeechMarkTypes: { shape: "S15" }, Text: {}, TextType: {}, VoiceId: {} },
            },
            output: {
                type: "structure",
                members: {
                    AudioStream: { type: "blob", streaming: !0 },
                    ContentType: { location: "header", locationName: "Content-Type" },
                    RequestCharacters: { location: "header", locationName: "x-amzn-RequestCharacters", type: "integer" },
                },
                payload: "AudioStream",
            },
        },
    ...
    shapes: {
        S2: { type: "string", sensitive: !0 },
        Sm: { type: "structure", members: { Alphabet: {}, LanguageCode: {}, LastModified: { type: "timestamp" }, LexiconArn: {}, LexemesCount: { type: "integer" }, Size: { type: "integer" } } },
        Sv: {
            type: "structure",
            members: {
                Engine: {},
    ...
    paginators: { ListSpeechSynthesisTasks: { input_token: "NextToken", output_token: "NextToken", limit_key: "MaxResults" } },
};
                    ...
                    t.util.update(t.STS.prototype, {
                        ...
                        optInRegionalEndpoint: function (e) {
                            var n = e.service,
                                i = n.config;
                            if (
                                ((i.stsRegionalEndpoints = r(n._originalConfig, { env: "AWS_STS_REGIONAL_ENDPOINTS", sharedConfig: "sts_regional_endpoints", clientConfig: "stsRegionalEndpoints" })),
                                "regional" === i.stsRegionalEndpoints && n.isGlobalEndpoint)
                            ) {
                                if (!i.region) throw t.util.error(new Error(), { code: "ConfigError", message: "Missing region in config" });
...
AWS.apiLoader.services.sts["2011-06-15"] = {
    ...
    operations: {
        AssumeRole: {
            ...
            output: { resultWrapper: "AssumeRoleResult", type: "structure", members: { Credentials: { shape: "Sh" }, AssumedRoleUser: { shape: "Sm" }, PackedPolicySize: { type: "integer" } } },
        },
        AssumeRoleWithSAML: {
            input: { type: "structure", required: ["RoleArn", "PrincipalArn", "SAMLAssertion"], members: { RoleArn: {}, PrincipalArn: {}, SAMLAssertion: {}, PolicyArns: { shape: "S4" }, Policy: {}, DurationSeconds: { type: "integer" } } },
            output: {
                resultWrapper: "AssumeRoleWithSAMLResult",
                type: "structure",
                members: { Credentials: { shape: "Sh" }, AssumedRoleUser: { shape: "Sm" }, PackedPolicySize: { type: "integer" }, Subject: {}, SubjectType: {}, Issuer: {}, Audience: {}, NameQualifier: {} },
            },
        },
        AssumeRoleWithWebIdentity: {
            input: {
                ...
                members: { RoleArn: {}, RoleSessionName: {}, WebIdentityToken: {}, ProviderId: {}, PolicyArns: { shape: "S4" }, Policy: {}, DurationSeconds: { type: "integer" } },
            },
            output: {
                resultWrapper: "AssumeRoleWithWebIdentityResult",
                type: "structure",
                members: { Credentials: { shape: "Sh" }, SubjectFromWebIdentityToken: {}, AssumedRoleUser: { shape: "Sm" }, PackedPolicySize: { type: "integer" }, Provider: {}, Audience: {} },
            },
        },
        DecodeAuthorizationMessage: {
            input: { type: "structure", required: ["EncodedMessage"], members: { EncodedMessage: {} } },
            output: { resultWrapper: "DecodeAuthorizationMessageResult", type: "structure", members: { DecodedMessage: {} } },
        },
        GetAccessKeyInfo: { input: { type: "structure", required: ["AccessKeyId"], members: { AccessKeyId: {} } }, output: { resultWrapper: "GetAccessKeyInfoResult", type: "structure", members: { Account: {} } } },
        GetCallerIdentity: { input: { type: "structure", members: {} }, output: { resultWrapper: "GetCallerIdentityResult", type: "structure", members: { UserId: {}, Account: {}, Arn: {} } } },
        GetFederationToken: {
            input: { type: "structure", required: ["Name"], members: { Name: {}, Policy: {}, PolicyArns: { shape: "S4" }, DurationSeconds: { type: "integer" }, Tags: { shape: "S8" } } },
            output: {
                resultWrapper: "GetFederationTokenResult",
                type: "structure",
                members: { Credentials: { shape: "Sh" }, FederatedUser: { type: "structure", required: ["FederatedUserId", "Arn"], members: { FederatedUserId: {}, Arn: {} } }, PackedPolicySize: { type: "integer" } },
            },
        },
        GetSessionToken: {
            input: { type: "structure", members: { DurationSeconds: { type: "integer" }, SerialNumber: {}, TokenCode: {} } },
            output: { resultWrapper: "GetSessionTokenResult", type: "structure", members: { Credentials: { shape: "Sh" } } },
        },
    },
    shapes: {
        S4: { type: "list", member: { type: "structure", members: { arn: {} } } },
        S8: { type: "list", member: { type: "structure", required: ["Key", "Value"], members: { Key: {}, Value: {} } } },
        Sh: { type: "structure", required: ["AccessKeyId", "SecretAccessKey", "SessionToken", "Expiration"], members: { AccessKeyId: {}, SecretAccessKey: {}, SessionToken: {}, Expiration: { type: "timestamp" } } },
        Sm: { type: "structure", required: ["AssumedRoleId", "Arn"], members: { AssumedRoleId: {}, Arn: {} } },
    },
    paginators: {},
};
